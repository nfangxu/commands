...
var Cmd = &cobra.Command{
	...
	Long:  "Create a project using the repository template. Example: fx create https://github.com/DoNewsCode/core-starter.git helloworld",
	Run:   run,
}
...
func run(cmd *cobra.Command, args []string) {
	...
	defer cancel()
	if len(args) == 0 {
		fmt.Fprintf(os.Stderr, "\033[31mERROR: project name is required.\033[m Example: fx create helloworld\n")
		return
	} else if len(args) == 1 {
		name = args[0]
		resp = starter
